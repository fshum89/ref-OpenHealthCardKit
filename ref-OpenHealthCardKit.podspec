#
#  Be sure to run `pod spec lint ref-OpenHealthCardKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ref-OpenHealthCardKit"
  spec.version      = "0.0.1"
  spec.summary      = "Controlling/Use-case framework for accessing smart cards of the telematic infrastructure."
